...
private static final long serialVersionUID = 0L;
  ...
  public static final int MANUFACTURINGYEAR_FIELD_NUMBER = 4;
  private volatile java.lang.Object manufacturingYear_;
  /**
   * <code>string manufacturingYear = 4;</code>
   */
  public java.lang.String getManufacturingYear() {
    java.lang.Object ref = manufacturingYear_;
    if (ref instanceof java.lang.String) {
      return (java.lang.String) ref;
    } else {
      com.google.protobuf.ByteString bs = 
  ...
  public static final int MODELYEAR_FIELD_NUMBER = 5;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getManufacturingYearBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 4, manufacturingYear_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!getManufacturingYearBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(4, manufacturingYear_);
    }
    if (!getModelYearBytes().isEmpty()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && getManufacturingYear()
        .equals(other.getManufacturingYear());
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + MANUFACTURINGYEAR_FIELD_NUMBER;
    hash = (53 * hash) + getManufacturingYear().hashCode();
  ...
  public static final class Builder extends
    ...
    public proto.Car buildPartial() {
      ...
      result.manufacturingYear_ = manufacturingYear_;
    ...
    public Builder mergeFrom(proto.Car other) {
      ...
      if (!other.getManufacturingYear().isEmpty()) {
        manufacturingYear_ = other.manufacturingYear_;
        onChanged();
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    private java.lang.Object manufacturingYear_ = "";
    /**
     * <code>string manufacturingYear = 4;</code>
     */
    public java.lang.String getManufacturingYear() {
     ...
     * <code>string manufacturingYear = 4;</code>
     */
    public Builder setManufacturingYear(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
  
      manufacturingYear_ = value;
      onChanged();
      return this;
    }
    /**
     * <code>string manufacturingYear = 4;</code>
     */
    public Builder clearManufacturingYear() {
      
      manufacturingYear_ = getDefaultInstance().getManufacturingYear();
      onChanged();
      return this;
    }
    /**
     * <code>string manufacturingYear = 4;</code>
     */
    public Builder setManufacturingYearBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
